#!/usr/bin/env bash
# Vendor Qiling into scripts/site. Heavier than unicorn (pulls capstone/keystone/pefile/
...
rm -rf "$RT/site"
echo "vendoring qiling into scripts/site (this pulls a few native deps)..."
